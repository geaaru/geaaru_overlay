...
EAPI=7
QA_PREBUILT="usr/lib*/oracle/21.23.0.0.0/client/lib*/lib*"
inherit eutils

DESCRIPTION=""
SRC_URI="https://download.oracle.com/otn_software/linux/instantclient/2123000/instantclient-basic-linux.x64-21.23.0.0.0dbru.zip -> instantclient-basic-linux.x64-21.23.0.0.0dbru.zip"
LICENSE="OTN"
SLOT="0"
KEYWORDS="*"
...
src_install() {
	...
	[[ -e libocci.so ]] ||
	dosym libocci.so.21.1 \
		"${oracle_home}"/$(get_libdir)/libocci.so
	[[ -e libclntsh.so ]] ||
	dosym libclntsh.so.21.1 \
