...
DESCRIPTION=""
SRC_URI="https://download.oracle.com/otn_software/linux/instantclient/1932000/instantclient-sdk-linux.x64-19.32.0.0.0dbru.zip -> instantclient-sdk-linux.x64-19.32.0.0.0dbru.zip"
LICENSE="OTN"
SLOT="0"
KEYWORDS="*"
PATCHES=(
...
src_install() {
	...
	dosym "${oracle_home}"/rdbms/public /usr/include/oracle/19.32.0.0.0/client
