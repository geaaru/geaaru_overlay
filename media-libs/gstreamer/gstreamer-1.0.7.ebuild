...
# $Header: /var/cvsroot/gentoo-x86/media-libs/gstreamer/gstreamer-1.0.6.ebuild,v 1.1 2013/03/31 23:18:22 eva Exp $
...
src_configure() {
	...
	econf \
		...
		--with-package-name="GStreamer ebuild for Gentoo (by Geaaru)" \
