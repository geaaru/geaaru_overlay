...
EGO_SUM=(
	...
	"aead.dev/minisign v0.2.1/go.mod"
	...
	"cloud.google.com/go/storage v1.40.0/go.mod"
	...
	"github.com/!i!b!m/sarama v1.43.1"
	"github.com/!i!b!m/sarama v1.43.1/go.mod"
	...
	"github.com/beevik/ntp v1.3.1/go.mod"
	...
	"github.com/coredns/coredns v1.11.2/go.mod"
	...
	"github.com/gobwas/ws v1.3.2/go.mod"
	...
	"github.com/google/pprof v0.0.0-20240416155748-26353dc0451f/go.mod"
	...
	"github.com/minio/console v1.4.0/go.mod"
	...
	"github.com/minio/mc v0.0.0-20240430174448-dcb911bed9d5/go.mod"
	...
	"github.com/minio/pkg/v2 v2.0.17/go.mod"
	...
	"github.com/nats-io/nats.go v1.34.1/go.mod"
	...
	"go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.50.0/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20240415180920-8c6c420018be/go.mod"
...
SRC_URI="
https://api.github.com/repos/minio/minio/tarball/RELEASE.2024-05-10T01-41-38Z -> minio-RELEASE.2024-05-10T01-41-38Z.tar.gz
https://direct.funtoo.org/4a/d4/3a/4ad43aa6babc79058f62e199434c69eece7fc6d043ed9e8d1a10205c99bae7e8bc4d632dfce93b3dff117a67f9f726301c6fdbd323a27c2b0fa1b1bb88b31f5f -> minio-2024.05.10.01.41.38-funtoo-go-bundle-b0676a8b37ca0102f35c32c706515b8cad1fa3b1a3ed5498d0d802314cd9a12931178dba771348aeab6c09ba0b3f50d3df0d03d6f2dcfc6bf5af4ab39a7ec4f5.tar.gz"
