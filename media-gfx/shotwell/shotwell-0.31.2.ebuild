...
PATCHES=(
	"${FILESDIR}"/shotwell_0fb9e8795e830f31a660eaa75678fd0af3fe729c.patch
	"${FILESDIR}"/shotwell_3a5904a23f9d7fe3a7d4d8dd4ea81136471b0692.patch
	"${FILESDIR}"/shotwell_0c5779bf9d9fa8f08696340dff1548b3c25374c6.patch
	"${FILESDIR}"/libgphoto2.patch
)
