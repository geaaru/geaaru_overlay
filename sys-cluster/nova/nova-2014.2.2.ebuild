...
RDEPEND="
	...
	>=dev-python/oslo-db-1.4.1[${PYTHON_USEDEP}]
	>=dev-python/oslo-rootwrap-1.5.0[${PYTHON_USEDEP}]
...
python_install() {
	...
	# Systemd files
	systemd_dounit "${FILESDIR}"/nova-api.service
	systemd_dounit "${FILESDIR}"/nova-cert.service
	systemd_dounit "${FILESDIR}"/nova-compute.service
	systemd_dounit "${FILESDIR}"/nova-conductor.service
	systemd_dounit "${FILESDIR}"/nova-consoleauth.service
	systemd_dounit "${FILESDIR}"/nova-network.service
