...
inherit distutils-r1 linux-info user systemd
...
python_install() {
	...
	# Systemd files
	systemd_dounit "${FILESDIR}"/neutron-dhcp-agent.service
	systemd_dounit "${FILESDIR}"/neutron-lbaas-agent.service
	systemd_dounit "${FILESDIR}"/neutron-mlnx-agent.service
	systemd_dounit "${FILESDIR}"/neutron-openvswitch-agent.service
	systemd_dounit "${FILESDIR}"/neutron-vpn-agent.service
	systemd_dounit "${FILESDIR}"/neutron-hyperv-agent.service
	systemd_dounit "${FILESDIR}"/neutron-linuxbridge-agent.service
	systemd_dounit "${FILESDIR}"/neutron-nec-agent.service
	systemd_dounit "${FILESDIR}"/neutron-restproxy-agent.service
	systemd_dounit "${FILESDIR}"/neutron-ibm-agent.service
	systemd_dounit "${FILESDIR}"/neutron-metadata-agent.service
	systemd_dounit "${FILESDIR}"/neutron-nvsd-agent.service
	systemd_dounit "${FILESDIR}"/neutron-ryu-agent.service
	systemd_dounit "${FILESDIR}"/neutron-l3-agent.service
	systemd_dounit "${FILESDIR}"/neutron-metering-agent.service
	systemd_dounit "${FILESDIR}"/neutron-ofagent-agent.service
	systemd_dounit "${FILESDIR}"/neutron-server.service
