...
SRC_URI="
	amd64? ( http://download.nvidia.com/XFree86/Linux-x86_64/555.42.02/NVIDIA-Linux-x86_64-555.42.02-no-compat32.run -> NVIDIA-Linux-x86_64-555.42.02-no-compat32.run )
	arm64? ( http://download.nvidia.com/XFree86/Linux-aarch64/555.42.02/NVIDIA-Linux-aarch64-555.42.02.run -> NVIDIA-Linux-aarch64-555.42.02.run )
"
