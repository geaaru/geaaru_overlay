...
RDEPEND="
	daemon? (
		app-arch/xz-utils
		>=app-emulation/lxc-3.2.2_pre20200304[seccomp]
		dev-libs/libuv
		dev-libs/lzo
...
#	eapply "${FILESDIR}/de-translation-newline-1.patch"
	...
	sed -i 's:zfs version:echo 0.8.2:g' configure.ac || die "Can't sed configure.ac for raft"
	eautoreconf
...
src_compile() {
	...
	emake CFLAGS="-I${GOPATH}/deps/sqlite -I${GOPATH}/deps/raft/include -I${GOPATH}/deps/libco/include" \
		LDFLAGS="-L${GOPATH}/deps/sqlite -L${GOPATH}/deps/raft -L${GOPATH}/deps/libco"
