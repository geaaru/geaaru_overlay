...
EGIT_COMMIT="c37c7b91afae06c21ea50ba49d82487fda0de0b2"
...
src_install() {
	...
	bashcomp_alias ${PN}-start \
		${PN}-{attach,autostart,cgroup,checkpoint,copy,config,console,create,destroy,device,execute,freeze,info,ls,monitor,monitord,snapshot,start,stop,unfreeze,unshare,user-nic,usernsexec,wait}
