...
IUSE="+asm bindist gmp kerberos rfc3779 sctp cpu_flags_x86_sse2 static-libs test +tls-heartbeat vanilla zlib weak-ciphers"
...
multilib_src_configure() {
	...
	local weak_ssl_ciphers=""
	if use weak-ciphers ; then
		weak_ssl_ciphers="enable-week-ssl-ciphers"
	fi
