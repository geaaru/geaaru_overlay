...
DESCRIPTION="jQuery.ui (XStatic package)"
HOMEPAGE="https://pypi.python.org/pypi/XStatic-jquery-ui"
MY_PN="XStatic-jquery-ui"
...
DEPEND="dev-python/setuptools[${PYTHON_USEDEP}]
		...
		>=dev-python/xstatic-jquery-1.10.2.1[${PYTHON_USEDEP}]
