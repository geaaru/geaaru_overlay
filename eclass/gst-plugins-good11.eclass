...
inherit eutils versionator gst-plugins11
...
#
# This list is current to gst-plugins-good-0.11.93:
...
# 6/2/2006 - zaheerm
if [ "${PN}" != "${MY_PN}" ]; then
RDEPEND="=media-libs/gst-plugins-base-0.11*"
DEPEND="${RDEPEND}
	>=sys-apps/sed-4
	virtual/pkgconfig"
...
gst-plugins-good11_src_compile() {
...
gst-plugins-good11_src_install() {
