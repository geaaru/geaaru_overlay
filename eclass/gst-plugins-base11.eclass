...
inherit eutils gst-plugins11 multilib

GST_EXPF="src_unpack src_compile src_install"
case ${EAPI:-0} in
	2|3|4) GST_EXPF="${GST_EXPF} src_prepare src_configure" ;;
	1|0)
...
gst-plugins-base11_src_unpack() {

	unpack ${A}

	cd "${S}"
	has src_prepare ${GST_EXPF} || gst-plugins-base11_src_prepare

}

gst-plugins-base11_src_prepare() {
...
gst-plugins-base11_src_compile() {

	has src_configure ${GST_EXPF} || gst-plugins-base11_src_configure ${@}
	gst-plugins11_find_plugin_dir
	emake || die "compile failure"

}

gst-plugins-base11_src_install() {
