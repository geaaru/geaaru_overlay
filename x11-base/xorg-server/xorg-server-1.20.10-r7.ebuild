...
IUSE_SERVERS="dmx kdrive xephyr xnest xorg xvfb wayland"
...
UPSTREAMED_PATCHES=(
	"${FILESDIR}"/xorg-server-1.20.10-backport-patch-for-CVE-2022-2319-CVE-2022-2320.patch
	"${FILESDIR}"/xorg-server-1.20.10-CVE-2022-2319.patch
	"${FILESDIR}"/xorg-server-1.20.10-CVE-2022-2320.patch
)
